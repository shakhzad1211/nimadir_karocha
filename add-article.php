    ...
    <main class="main oh" id="main">
        ...
        <div class="main-container container pt-80 pb-80" id="main-container">
            ...
            <div class="blog__content mb-72">
                ...
                <form action="components/add_article.php" method="post"> 
                ...
                <?php
                    include '_database/database.php';
                         ...
                         $result = mysqli_query($database,$sql) or die(mysqli_error($database));
                          ...
                          <option value="<?php echo $rws['Name'] ?>"><?php echo $rws['Name'] ?></option>
                          <?php }?>
                </select>
                ...
                <?php
                    include '_database/database.php';
                         ...
                         $result = mysqli_query($database,$sql) or die(mysqli_error($database));
                          while($rws = mysqli_fetch_array($result)){ ?>
                          <option value="<?php echo $rws['Author_username'] ?>"><?php echo $rws['FName'] ?> <?php echo $rws['LName'] ?></option>
                          <?php }?>
                </select>
                <input type="text" name="Theme" placeholder="Theme">
           
            <textarea name="editor1" id="editor1" rows="10" cols="80" placeholder="Maqola matnini kiriting">

            </textarea>
            <br>
            <button type="submit" class="btn btn-primary" data-style="zoom-in" value="Upload" id="SubmitButton" name="add-article">Add article</button>            <script src="js/ckeditor.js"></script>
