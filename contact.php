...
<body class="style-default style-rounded">
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-8">
                        ...
                        <ul class="contact-items">
                            <li class="contact-item"><address>Kamoliddin Behzod nomidagi Milliy rassomlik va dizayn instituti</address></li>
                            <li class="contact-item"><a href="tel:+ 998 71 255 96 91">+ 998 (71) 255 96 91</a></li>
                            <li class="contact-item"><a href="mailto:info@mrdi.uz">info@mrdi.uz</a></li>
                        </ul>

                        <!-- Contact Form -->
                        <form id="contact-form" class="contact-form mt-30 mb-30" method="post" action="components/contact_us.php">
                            <div class="contact-name">
                                <label for="name">Name <abbr title="required"  class="required">*</abbr></label>
                                <input name="name" id="name" type="text" required="rewuired">
                            </div>
                            ...
                            <input type="submit" class="btn btn-lg btn-color btn-button" name="send_message" value="Send message" id="send_message">
  ...
  -->
    <script src="../../../maps/api/js?key=AIzaSyCoQ3_zzRfW-hYspkwr5kvwCwLPGZsN4nw"></script>
...
<!-- Copied from https://deothemes.com/envato/deus/php/contact.html by Cyotek WebCopy 1.8.0.620, 30 декабря 2019 г., 6:28:59 -->
