...
<head>
    <title>Deus | Successful added</title>
        ...
        <div class="main-container container pt-80 pb-80" id="main-container">
            ...
            <div class="blog__content mb-72">
                <div class="container text-center">
                    <h2 class="page-404-number">Successful added article</h2>
                    ...
                    <div class="row justify-content-center mt-40">
                        ...
                        <div class="col-md-6">
                            ...
                            <a href="index.php" class="btn btn-lg btn-light mt-40"><span>Back to Home</span></a>
                        </div>
